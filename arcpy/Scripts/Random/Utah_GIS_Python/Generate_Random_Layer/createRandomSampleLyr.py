...
#This script is built to be a "script tool" that you fire off from ArcGIS Toolbox. The user points to a 
#feature class and specifies a number of random features to return, and the tool will add a random 
#subset of your data as a .lyr back to ArcMap. I'll be using this for quality control.
