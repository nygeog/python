...
#Local Variables
workspace = D:/GIS/projects/fitnessgram/data/geocoding/dbf #"CHANGE THIS TO THE FOLDER PATH WHERE YOUR TABLE IS STORED. EXAMPLE: C:/TEST"
tableinput = D:/GIS/projects/fitnessgram/data/geocoding/dbf/bp_1_esri.dbf #"CHANGE THIS TO THE FULL PATH OF YOUR TABLE.  EXAMPLE C:/TEST/TABLE.DBF"

#Define Workspace
env.workspace = workspace

 #Create a new CSV file in this location
writer = csv.writer(file('D:/GIS/projects/fitnessgram/data/geocoding/dbf/bP_1.csv', 'wb'))  #Change"C:/test/attributes.csv" to the location where you want your new table to be
