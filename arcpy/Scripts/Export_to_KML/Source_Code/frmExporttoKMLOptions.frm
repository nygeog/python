...
Begin VB.Form frmExporttoKMLOptions 
   ...
   Begin TabDlg.SSTab tabExportOptions 
      ...
      Tab(1).Control(0)=   "fraFeatureSnippet"
      Tab(1).Control(1)=   "lstSnippetAttributes"
      Tab(1).Control(2)=   "chkForcePointsInside"
      Tab(1).Control(3)=   "fraFeatureDescription"
      Tab(1).Control(4)=   "chkExportSeparateLabels"
      Tab(1).Control(5)=   "cboFeatureNameAttribute"
      Tab(1).Control(6)=   "chkColorLabels"
      Tab(1).Control(7)=   "lstDescriptionAttributes"
      Tab(1).Control(8)=   "chkCreateInfoPoints"
      Tab(1).Control(9)=   "cmdAddAllAttributes"
      Tab(1).Control(10)=   "chkLabelNullValues"
      Tab(1).Control(11)=   "lblSnippetAttributes"
      Tab(1).Control(12)=   "lblFeatureSnippet"
      Tab(1).Control(13)=   "lblFeatureNameAttribute"
      Tab(1).Control(14)=   "lblDescriptionAttributes"
      Tab(1).Control(15)=   "lblDescription"
      Tab(1).Control(16)=   "linDescription"
      Tab(1).ControlCount=   17
      TabCaption(2)   =   "3D Options"
      TabPicture(2)   =   "frmExporttoKMLOptions.frx":62C2
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "lblAltitudeMode"
      Tab(2).Control(1)=   "lblOffsetAttribute"
      Tab(2).Control(2)=   "lblOffsetManual"
      Tab(2).Control(3)=   "lblLabelOffsetManual"
      Tab(2).Control(4)=   "lblInfoPtOffsetManual"
      Tab(2).Control(5)=   "optAMAbsolute"
      Tab(2).Control(6)=   "optAMRelative"
      Tab(2).Control(7)=   "cboOffsetAttribute"
      Tab(2).Control(8)=   "optAMClamped"
      Tab(2).Control(9)=   "txtOffsetManual"
      Tab(2).Control(10)=   "txtLabelOffsetManual"
      Tab(2).Control(11)=   "txtInfoPtOffsetManual"
      Tab(2).ControlCount=   12
      TabCaption(3)   =   "Time Options"
      TabPicture(3)   =   "frmExporttoKMLOptions.frx":62DE
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "lblTimeStampInfo"
      Tab(3).Control(1)=   "lblStartTime"
      Tab(3).Control(2)=   "lblEndTime"
      Tab(3).Control(3)=   "cboStartTime"
      Tab(3).Control(4)=   "cboEndTime"
      Tab(3).Control(5)=   "chkFormatDateTime"
      Tab(3).ControlCount=   6
      TabCaption(4)   =   "Database Schema Options"
      TabPicture(4)   =   "frmExporttoKMLOptions.frx":62FA
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "lblNoteAboutDescription"
      Tab(4).Control(1)=   "lblTableAttributesExport"
      Tab(4).Control(2)=   "lblTableAttributesMaster"
      Tab(4).Control(3)=   "lblSchemaInfo"
      Tab(4).Control(4)=   "cmdDown"
      Tab(4).Control(5)=   "cmdUp"
      Tab(4).Control(6)=   "cmdRemove"
      Tab(4).Control(7)=   "cmdAdd"
      Tab(4).Control(8)=   "lstTableAttributesExport"
      Tab(4).Control(9)=   "lstTableAttributesMaster"
      Tab(4).Control(10)=   "chkExportSchema"
      Tab(4).Control(11)=   "chkUseUnTypedData"
      Tab(4).ControlCount=   12
      TabCaption(5)   =   "About ""Export to KML"""
      TabPicture(5)   =   "frmExporttoKMLOptions.frx":6316
      Tab(5).ControlEnabled=   -1  'True
      Tab(5).Control(0)=   "Line2"
      Tab(5).Control(0).Enabled=   0   'False
      Tab(5).Control(1)=   "Line1"
      Tab(5).Control(1).Enabled=   0   'False
      Tab(5).Control(2)=   "imgExporttoKML"
      Tab(5).Control(2).Enabled=   0   'False
      Tab(5).Control(3)=   "lblDisclaimer"
      Tab(5).Control(3).Enabled=   0   'False
      Tab(5).Control(4)=   "lblDisclaimer2"
      Tab(5).Control(4).Enabled=   0   'False
      Tab(5).Control(5)=   "cmdCheckforUpdates"
